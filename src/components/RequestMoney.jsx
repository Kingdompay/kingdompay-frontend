        ...
        <div className="md:w-1/3 lg:w-1/4 bg-white md:border-r md:border-gray-100 flex flex-col">
          ...
          <header className="sticky top-0 z-10 p-4 bg-white md:bg-transparent">
            <div className="flex justify-between items-center">
              ...
              <h1 className="text-lg font-bold text-[#1A3F22] m-0">Request Money</h1>
          ...
          <div className="max-w-2xl mx-auto animate-fade-in-up">
            ...
            {step === 1 && (
              <div className="space-y-6">
                <h2 className="text-xl font-semibold text-[#1A3F22]">Who do you want to request money from?</h2>
            ...
            {step === 2 && (
              <div className="space-y-6">
                <h2 className="text-xl font-semibold text-[#1A3F22]">How much do you want to request?</h2>
                ...
                {/* Category */}
                <div>
                  <label className="block text-sm font-medium mb-2 text-[#1A3F22]">Category</label>
                  <select
                    name="category"
                    value={formData.category}
                    onChange={handleChange}
                    className="w-full p-3 rounded-xl border-2 outline-none transition-colors bg-gray-50 border-gray-200 focus:border-[#6f9c16] text-gray-900"
                  >
                    {categories.map((cat) => (
                ...
                {/* Due Date */}
                <div>
                  <label className="block text-sm font-medium mb-2 text-[#1A3F22]">Due Date (Optional)</label>
                  <input
                    type="date"
                    name="dueDate"
            ...
            {step === 3 && (
              <div className="space-y-6">
                <h2 className="text-xl font-semibold text-[#1A3F22]">Review your request</h2>

                <div className="p-6 rounded-2xl border bg-gray-50 border-gray-200">
                  <div className="flex justify-between items-center mb-4">
                    <span className="text-gray-500">From</span>
                    <span className="font-semibold text-[#1A3F22]">{formData.requester}</span>
                  </div>
                  <div className="flex justify-between items-center mb-4">
                  ...
                  {formData.dueDate && (
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <span className="font-semibold text-[#1A3F22]">{formData.dueDate}</span>
                    </div>
                  )}
                  {formData.message && (
